...
// CPU_SCHED_CONFIG is generated by build.rs from the CPU_SCHED env var.
// It is a &str const with the raw config string, e.g. "0:eevdf,1:fifo".
#[cfg(feature = "sched-per-cpu")]
include!(concat!(env!("OUT_DIR"), "/cpu_sched_config.rs"));
...
pub fn rust_main(cpu_id: usize, arg: usize) -> ! {
    ...
    #[cfg(feature = "multitask")]
    {
        #[cfg(feature = "sched-per-cpu")]
        {
            info!("CPU_SCHED config baked in at compile time: {:?}", CPU_SCHED_CONFIG);
            axtask::setup_per_cpu_schedulers(CPU_SCHED_CONFIG);
        }
